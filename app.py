...
if "chat_session" not in st.session_state:
  # Seed conversation history with hidden prompt
  initial_prompt = "you are fitness guru. ask user how can I help you and start conversation."  # This prompt won't be displayed
...
# Display the chat history (optional, can be removed)
