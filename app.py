...
# Define the extra prompt (modify as needed)
extra_prompt = " (In fitness guru persona, answer user questions)"
...
if "chat_session" not in st.session_state:
  ...
  # Send message with extra prompt for initial session
  initial_response_with_prompt = st.session_state.chat_session.send_message(initial_prompt + extra_prompt)
...
if user_prompt:
  try:
    ...
    # Send user's message without extra prompt for subsequent messages
